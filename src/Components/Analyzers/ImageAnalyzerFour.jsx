...
import errorBackground from './ErrorImagesForAnalyzers/NoEncontradaAzul.jpg'

export const ImageAnalyzerFour = (props) => {
        ...
        <div className='ImageAnalizer'>
            ...
            style={ 
                ...
                :{backgroundImage: `url("https://soho.nascom.nasa.gov/data/synoptic/sunspots/sunspots_1024_${displaiedImageDate}.jpg")`}
                    ...
                    <div className="sendedAlert" id="sendedBlue">Coordenadas enviadas</div>
